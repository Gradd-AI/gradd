...
`;
  ...
  // TEMP DEBUG — remove after burn verified
  console.error('[BURN_DEBUG]', { isFreeTier, free_units_used: profile.free_units_used ?? 0, burnActiveInjected: liveContextAnchor.includes('BURN_ACTIVE: true') });
