...
export function PED_ELASTIC_INELASTIC() {
  return (
    <svg viewBox="0 0 540 410" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 540, fontFamily: FONT }}>
      <text x="270" y="16" fontSize="12" fill={MUTED} textAnchor="middle">Price Elasticity of Demand — Elastic vs Inelastic</text>
      {/* Elastic — left panel */}
      <g transform="translate(0,0)">
        ...
        <text x="140" y="395" fontSize="10" fill={MUTED} textAnchor="middle">PED {'>'} 1</text>
      </g>
...
export function PED_PERFECTLY_ELASTIC() {
  return (
    <svg viewBox="0 0 460 390" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 460, fontFamily: FONT }}>
      <text x="230" y="16" fontSize="12" fill={MUTED} textAnchor="middle">Perfectly Elastic Demand (PED = ∞)</text>
...
export function PED_PERFECTLY_INELASTIC() {
  return (
    <svg viewBox="0 0 460 390" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 460, fontFamily: FONT }}>
      <text x="230" y="16" fontSize="12" fill={MUTED} textAnchor="middle">Perfectly Inelastic Demand (PED = 0)</text>
      <Axes width={420} height={350} />
...
export function PRICE_CEILING() {
  return (
    <svg viewBox="0 0 500 430" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      <text x="250" y="16" fontSize="12" fill={MUTED} textAnchor="middle">Price Ceiling (Maximum Price)</text>
...
export function PRICE_FLOOR() {
  return (
    <svg viewBox="0 0 500 430" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      <text x="250" y="16" fontSize="12" fill={MUTED} textAnchor="middle">Price Floor (Minimum Price)</text>
      <Axes width={460} height={370} />
      <line x1="80" y1="60" x2="420" y2="340" stroke={BLUE} strokeWidth="2.5" />
      <text x="410" y="328" fontSize="14" fill={BLUE} fontWeight="bold">D</text>
      <line x1="80" y1="340" x2="420" y2="60" stroke={RED} strokeWidth="2.5" />
...
export function NEG_EXT_PRODUCTION() {
  return (
    <svg viewBox="0 0 500 440" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      ...
      <text x="230" y="215" fontSize="10" fill={AMBER} textAnchor="middle">WL</text>
...
export function NEG_EXT_CONSUMPTION() {
  return (
    <svg viewBox="0 0 500 440" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      <text x="250" y="16" fontSize="12" fill={MUTED} textAnchor="middle">Negative Externality of Consumption</text>
      <Axes width={460} height={370} xlabel="Quantity" ylabel="Price / Cost" />
      {/* Supply = MSC */}
      <line x1="80" y1="330" x2="420" y2="70" stroke={RED} strokeWidth="2.5" />
      <text x="425" y="82" fontSize="12" fill={RED} fontWeight="bold">MSC = S</text>
      {/* MPB (market demand — what consumers value privately) */}
      <line x1="80" y1="60" x2="420" y2="320" stroke={BLUE} strokeWidth="2.5" />
      <text x="425" y="308" fontSize="12" fill={BLUE} fontWeight="bold">MPB (D)</text>
      {/* MSB — below MPB */}
      <line x1="80" y1="120" x2="380" y2="330" stroke={PURPLE} strokeWidth="2.5" />
      <text x="385" y="318" fontSize="12" fill={PURPLE} fontWeight="bold">MSB</text>
      {/* Market Q */}
      ...
      <text x="232" y="222" fontSize="10" fill={AMBER} textAnchor="middle">WL</text>
...
export function POS_EXT_PRODUCTION() {
  return (
    <svg viewBox="0 0 500 440" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      <text x="250" y="16" fontSize="12" fill={MUTED} textAnchor="middle">Positive Externality of Production</text>
      <Axes width={460} height={370} xlabel="Quantity" ylabel="Price / Cost" />
      <line x1="80" y1="60" x2="420" y2="330" stroke={BLUE} strokeWidth="2.5" />
      <text x="425" y="318" fontSize="12" fill={BLUE} fontWeight="bold">MSB = D</text>
      {/* MPC — higher cost (market) */}
      <line x1="80" y1="300" x2="400" y2="60" stroke={RED} strokeWidth="2.5" />
      <text x="405" y="72" fontSize="12" fill={RED} fontWeight="bold">MPC (S)</text>
      {/* MSC — below MPC (external benefits reduce net cost) */}
      <line x1="80" y1="360" x2="420" y2="100" stroke={BRAND} strokeWidth="2.5" />
      <text x="425" y="112" fontSize="12" fill={BRAND} fontWeight="bold">MSC</text>
...
export function POS_EXT_CONSUMPTION() {
  return (
    <svg viewBox="0 0 500 440" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      <text x="250" y="16" fontSize="12" fill={MUTED} textAnchor="middle">Positive Externality of Consumption</text>
      <Axes width={460} height={370} xlabel="Quantity" ylabel="Price / Cost" />
      <line x1="80" y1="330" x2="420" y2="70" stroke={RED} strokeWidth="2.5" />
      <text x="425" y="82" fontSize="12" fill={RED} fontWeight="bold">MSC = S</text>
      {/* MPB */}
      ...
      <text x="425" y="258" fontSize="12" fill={BRAND} fontWeight="bold">MSB</text>
      {/* Market Q */}
      <circle cx="250" cy="195" r="5" fill={BLUE} />
      <line x1="250" y1="195" x2="250" y2="370" stroke={BLUE} strokeWidth="1" strokeDasharray="4,3" />
...
export function LORENZ_CURVE() {
  return (
    <svg viewBox="0 0 460 440" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 460, fontFamily: FONT }}>
      <text x="230" y="16" fontSize="12" fill={MUTED} textAnchor="middle">Lorenz Curve and Gini Coefficient</text>
      {/* Axes */}
      ...
      <text x="425" y="24" fontSize="11" fill={MUTED}>Line of equality</text>
      {/* Lorenz curve */}
      <path d="M 60,370 Q 160,360 240,280 Q 340,180 420,30" fill="none" stroke={BRAND} strokeWidth="2.5" />
      <text x="310" y="250" fontSize="12" fill={BRAND} fontWeight="bold">Lorenz Curve</text>
      {/* Gini shading */}
      ...
      {/* Axis tick labels */}
      <text x="60" y="388" fontSize="10" fill={MUTED} textAnchor="middle">0%</text>
      <text x="240" y="388" fontSize="10" fill={MUTED} textAnchor="middle">50%</text>
      <text x="420" y="388" fontSize="10" fill={MUTED} textAnchor="middle">100%</text>
...
export function MONOPOLY() {
  return (
    <svg viewBox="0 0 520 450" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 520, fontFamily: FONT }}>
      <text x="260" y="16" fontSize="12" fill={MUTED} textAnchor="middle">Monopoly — Profit Maximisation and Deadweight Loss (HL)</text>
      ...
      <text x="445" y="348" fontSize="12" fill={BLUE} fontWeight="bold">AR (D)</text>
      {/* MR — twice as steep */}
      <line x1="80" y1="60" x2="260" y2="360" stroke={PURPLE} strokeWidth="2" />
      <text x="265" y="348" fontSize="12" fill={PURPLE} fontWeight="bold">MR</text>
      {/* MC */}
      <line x1="80" y1="300" x2="440" y2="100" stroke={RED} strokeWidth="2" />
      <text x="445" y="112" fontSize="12" fill={RED} fontWeight="bold">MC</text>
      {/* AC — U-shaped approx */}
      ...
      <text x="240" y="240" fontSize="10" fill={AMBER} textAnchor="middle">DWL</text>
