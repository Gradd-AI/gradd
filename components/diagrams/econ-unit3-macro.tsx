...
export function BUSINESS_CYCLE() {
  return (
    <svg viewBox="0 0 520 420" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 520, fontFamily: FONT }}>
      <text x="260" y="16" fontSize="13" fill={MUTED} textAnchor="middle">The Business Cycle</text>
      ...
      <text x="22" y="200" fontSize="13" fill={STROKE} textAnchor="middle" transform="rotate(-90,22,200)">Real GDP</text>
      {/* Long-run trend */}
...
export function LRAS_MONETARIST() {
  return (
    <svg viewBox="0 0 480 430" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 480, fontFamily: FONT }}>
      <text x="240" y="16" fontSize="13" fill={MUTED} textAnchor="middle">Monetarist / New Classical LRAS</text>
      ...
      {/* Yfe label */}
      <text x="250" y="388" fontSize="13" fill={BRAND} textAnchor="middle">Yfe</text>
...
export function AS_KEYNESIAN() {
  return (
    <svg viewBox="0 0 500 440" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      <text x="250" y="16" fontSize="13" fill={MUTED} textAnchor="middle">Keynesian Aggregate Supply Curve</text>
      ...
      <text x="405" y="72" fontSize="14" fill={RED} fontWeight="bold">AS</text>
      {/* Zones */}
...
export function LRAS_SHIFT() {
  return (
    <svg viewBox="0 0 500 420" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      <text x="250" y="16" fontSize="13" fill={MUTED} textAnchor="middle">Outward Shift of LRAS (Long-run Growth)</text>
      <Axes width={460} height={370} />
      ...
      <text x="348" y="50" fontSize="14" fill={BRAND} fontWeight="bold">LRAS₂</text>
...
export function MACRO_EQUILIBRIUM_LR() {
  return (
    <svg viewBox="0 0 500 450" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      <text x="250" y="16" fontSize="13" fill={MUTED} textAnchor="middle">Long-run Equilibrium + Inflationary / Deflationary Gap</text>
      <Axes width={460} height={380} />
      <path d="M 80,60 Q 240,140 400,350" fill="none" stroke={BLUE} strokeWidth="2.5" />
      <text x="405" y="338" fontSize="14" fill={BLUE} fontWeight="bold">AD</text>
      ...
      <text x="268" y="50" fontSize="14" fill={BRAND} fontWeight="bold">LRAS</text>
      <text x="260" y="398" fontSize="13" fill={BRAND} textAnchor="middle">Yfe</text>
...
export function DEMAND_PULL_INFLATION() {
  return (
    <svg viewBox="0 0 500 436" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      ...
      <text x="425" y="82" fontSize="14" fill={RED} fontWeight="bold">SRAS</text>
      {/* AD1 */}
      ...
      <text x="455" y="298" fontSize="14" fill={BRAND} fontWeight="bold">AD₂</text>
      {/* E1 */}
...
export function COST_PUSH_INFLATION() {
  return (
    <svg viewBox="0 0 500 436" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      ...
      <text x="385" y="72" fontSize="14" fill={RED} fontWeight="bold">SRAS₂</text>
      {/* E1 */}
...
export function PHILLIPS_CURVE_SR() {
  return (
    <svg viewBox="0 0 480 430" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 480, fontFamily: FONT }}>
      <text x="240" y="16" fontSize="13" fill={MUTED} textAnchor="middle">Short-run Phillips Curve (HL)</text>
      <line x1="60" y1="20" x2="60" y2="370" stroke={STROKE} strokeWidth="2" />
      ...
      <text x="385" y="328" fontSize="14" fill={BRAND} fontWeight="bold">SRPC</text>
      {/* Points */}
...
export function PHILLIPS_CURVE_LR() {
  return (
    <svg viewBox="0 0 500 450" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      <text x="250" y="16" fontSize="13" fill={MUTED} textAnchor="middle">Long-run Phillips Curve (HL)</text>
      ...
      <line x1="260" y1="30" x2="260" y2="380" stroke={BRAND} strokeWidth="3" />
      <text x="268" y="50" fontSize="14" fill={BRAND} fontWeight="bold">LRPC</text>
      <text x="260" y="398" fontSize="13" fill={BRAND} textAnchor="middle">NRU</text>
      {/* Expectations arrows */}
...
export function CROWDING_OUT() {
  return (
    <svg viewBox="0 0 500 440" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      <text x="250" y="16" fontSize="13" fill={MUTED} textAnchor="middle">Crowding-Out Effect (HL)</text>
      <line x1="60" y1="20" x2="60" y2="380" stroke={STROKE} strokeWidth="2" />
      <line x1="60" y1="380" x2="460" y2="380" stroke={STROKE} strokeWidth="2" />
      <polygon points="60,12 55,24 65,24" fill={STROKE} />
      <polygon points="468,380 456,375 456,385" fill={STROKE} />
      <text x="260" y="408" fontSize="12" fill={STROKE} textAnchor="middle">Quantity of Loanable Funds</text>
      <text x="22" y="200" fontSize="13" fill={STROKE} textAnchor="middle" transform="rotate(-90,22,200)">Real Interest Rate</text>
      {/* Supply of loanable funds — upward */}
      <line x1="80" y1="340" x2="420" y2="60" stroke={BRAND} strokeWidth="2.5" />
      <text x="425" y="72" fontSize="14" fill={BRAND} fontWeight="bold">S</text>
      {/* Original demand D1 */}
      ...
      <text x="445" y="328" fontSize="14" fill={RED} fontWeight="bold">D₂</text>
      {/* E1 */}
...
export function SUPPLY_SIDE_LRAS() {
  return (
    <svg viewBox="0 0 500 436" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      ...
      <text x="368" y="50" fontSize="14" fill={BRAND} fontWeight="bold">LRAS₂</text>
...
export function UNEMPLOYMENT_MINIMUM_WAGE() {
  return (
    <svg viewBox="0 0 480 430" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 480, fontFamily: FONT }}>
      <text x="240" y="16" fontSize="13" fill={MUTED} textAnchor="middle">Minimum Wage and Unemployment</text>
      <line x1="60" y1="20" x2="60" y2="370" stroke={STROKE} strokeWidth="2" />
      <line x1="60" y1="370" x2="440" y2="370" stroke={STROKE} strokeWidth="2" />
      <polygon points="60,12 55,24 65,24" fill={STROKE} />
      <polygon points="448,370 436,365 436,375" fill={STROKE} />
      ...
      <text x="405" y="328" fontSize="14" fill={BLUE} fontWeight="bold">D (Labour)</text>
      {/* Labour supply */}
      <line x1="80" y1="340" x2="400" y2="60" stroke={RED} strokeWidth="2.5" />
      <text x="405" y="74" fontSize="14" fill={RED} fontWeight="bold">S (Labour)</text>
      {/* Equilibrium wage */}
