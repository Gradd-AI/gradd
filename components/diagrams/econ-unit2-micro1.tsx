...
export function DEMAND_SHIFT() {
  return (
    <svg viewBox="0 0 500 422" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      ...
      <text x="368" y="328" fontSize="14" fill={BLUE} fontStyle="italic">D₁</text>
      {/* Rightward shift (increase) */}
      <line x1="200" y1="60" x2="450" y2="330" stroke={BRAND} strokeWidth="2.5" />
      <text x="440" y="318" fontSize="14" fill={BRAND} fontWeight="bold">D₂</text>
      {/* Leftward shift (decrease) */}
      <line x1="60" y1="100" x2="260" y2="340" stroke={RED} strokeWidth="2" strokeDasharray="6,4" />
      <text x="248" y="328" fontSize="14" fill={RED} fontStyle="italic">D₃</text>
      {/* Arrows */}
...
export function SUPPLY_SHIFT() {
  return (
    <svg viewBox="0 0 500 422" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      ...
      <text x="368" y="72" fontSize="14" fill={RED} fontStyle="italic">S₁</text>
      {/* Rightward shift (increase in supply) */}
      <line x1="200" y1="340" x2="450" y2="70" stroke={BRAND} strokeWidth="2.5" />
      <text x="440" y="82" fontSize="14" fill={BRAND} fontWeight="bold">S₂</text>
      {/* Leftward shift (decrease) */}
