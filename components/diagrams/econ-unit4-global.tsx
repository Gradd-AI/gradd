...
export function EXCHANGE_RATE_FLOATING() {
  return (
    <svg viewBox="0 0 480 430" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 480, fontFamily: FONT }}>
      <text x="240" y="16" fontSize="12" fill={MUTED} textAnchor="middle">Floating Exchange Rate Determination</text>
      ...
      <text x="405" y="328" fontSize="13" fill={BLUE} fontWeight="bold">D (€)</text>
      {/* Supply of € — upward sloping */}
      <line x1="80" y1="340" x2="400" y2="60" stroke={RED} strokeWidth="2.5" />
      <text x="405" y="74" fontSize="13" fill={RED} fontWeight="bold">S (€)</text>
      {/* Equilibrium */}
      ...
      <text x="52" y="204" fontSize="12" fill={AMBER} textAnchor="end">ER*</text>
      <text x="240" y="388" fontSize="12" fill={AMBER} textAnchor="middle">Q*</text>
...
export function EXCHANGE_RATE_CHANGE() {
  return (
    <svg viewBox="0 0 500 430" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      <text x="250" y="16" fontSize="12" fill={MUTED} textAnchor="middle">Currency Appreciation (Demand Increase)</text>
      ...
      <text x="425" y="74" fontSize="12" fill={RED} fontWeight="bold">S (€)</text>
      {/* D1 */}
      ...
      <text x="455" y="298" fontSize="12" fill={BRAND} fontWeight="bold">D₂</text>
      {/* E1 */}
...
export function EXCHANGE_RATE_FIXED() {
  return (
    <svg viewBox="0 0 500 450" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      <text x="250" y="16" fontSize="12" fill={MUTED} textAnchor="middle">Maintaining a Fixed Exchange Rate</text>
      ...
      <text x="455" y="318" fontSize="12" fill={BLUE} fontWeight="bold">D</text>
      {/* Free market rate */}
      ...
      <text x="465" y="224" fontSize="12" fill={AMBER} fontWeight="bold">Fixed ER</text>
...
export function EXCHANGE_RATE_MANAGED() {
  return (
    <svg viewBox="0 0 500 430" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      <text x="250" y="16" fontSize="12" fill={MUTED} textAnchor="middle">Managed Exchange Rate (Crawling Peg / Managed Float)</text>
      ...
      <text x="425" y="82" fontSize="12" fill={RED} fontWeight="bold">S</text>
      <line x1="80" y1="60" x2="400" y2="340" stroke={BLUE} strokeWidth="2.5" />
      <text x="405" y="328" fontSize="12" fill={BLUE} fontWeight="bold">D</text>
      {/* Free market rate */}
      ...
      <text x="465" y="144" fontSize="11" fill={BRAND}>Upper band</text>
      {/* Lower band */}
      <line x1="60" y1="260" x2="460" y2="260" stroke={PURPLE} strokeWidth="1.5" strokeDasharray="6,4" />
      <text x="465" y="264" fontSize="11" fill={PURPLE}>Lower band</text>
      {/* Shaded band */}
...
export function TARIFF() {
  return (
    <svg viewBox="0 0 520 460" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 520, fontFamily: FONT }}>
      <text x="260" y="16" fontSize="12" fill={MUTED} textAnchor="middle">Effect of a Tariff</text>
      ...
      <text x="16" y="210" fontSize="12" fill={STROKE} textAnchor="middle" transform="rotate(-90,16,210)">Price</text>
      {/* Domestic supply */}
      <line x1="80" y1="370" x2="380" y2="70" stroke={RED} strokeWidth="2.5" />
      <text x="385" y="82" fontSize="12" fill={RED} fontWeight="bold">Sd</text>
      {/* Domestic demand */}
      <line x1="80" y1="70" x2="440" y2="370" stroke={BLUE} strokeWidth="2.5" />
      <text x="445" y="358" fontSize="12" fill={BLUE} fontWeight="bold">Dd</text>
      ...
      <text x="148" y="408" fontSize="10" fill={MUTED} textAnchor="middle">Qs₁</text>
      <text x="182" y="408" fontSize="10" fill={AMBER} textAnchor="middle">Qs₂</text>
      <text x="318" y="408" fontSize="10" fill={AMBER} textAnchor="middle">Qd₂</text>
      <text x="362" y="408" fontSize="10" fill={MUTED} textAnchor="middle">Qd₁</text>
...
export function IMPORT_QUOTA() {
  return (
    <svg viewBox="0 0 520 450" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 520, fontFamily: FONT }}>
      <text x="260" y="16" fontSize="12" fill={MUTED} textAnchor="middle">Import Quota Effect</text>
      ...
      <text x="16" y="200" fontSize="12" fill={STROKE} textAnchor="middle" transform="rotate(-90,16,200)">Price</text>
      <line x1="80" y1="360" x2="380" y2="60" stroke={RED} strokeWidth="2.5" />
      <text x="385" y="72" fontSize="12" fill={RED} fontWeight="bold">Sd</text>
      <line x1="80" y1="60" x2="440" y2="360" stroke={BLUE} strokeWidth="2.5" />
      <text x="445" y="348" fontSize="12" fill={BLUE} fontWeight="bold">Dd</text>
      {/* World price */}
      ...
      <text x="460" y="72" fontSize="12" fill={BRAND} fontWeight="bold">Sd + Q</text>
      {/* New equilibrium */}
...
export function J_CURVE() {
  return (
    <svg viewBox="0 0 480 430" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 480, fontFamily: FONT }}>
      <text x="240" y="16" fontSize="12" fill={MUTED} textAnchor="middle">J-Curve Effect (HL)</text>
      <line x1="60" y1="20" x2="60" y2="380" stroke={STROKE} strokeWidth="2" />
      ...
      <text x="16" y="200" fontSize="12" fill={STROKE} textAnchor="middle" transform="rotate(-90,16,200)">Current Account Balance</text>
      {/* Zero line */}
...
export function TERMS_OF_TRADE() {
  return (
    <svg viewBox="0 0 500 400" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', maxWidth: 500, fontFamily: FONT }}>
      <text x="250" y="16" fontSize="12" fill={MUTED} textAnchor="middle">Terms of Trade (HL)</text>
      {/* Formula box */}
      ...
      <text x="250" y="98" fontSize="12" fill={MUTED} textAnchor="middle">A rise in ToT = improvement (exports buy more imports)</text>
      ...
      <text x="18" y="200" fontSize="11" fill={STROKE} textAnchor="middle" transform="rotate(-90,18,200)">ToT Index</text>
