 ...
 * Nothing here is invented or inferred: where the guide is silent (e.g. Section G
 * has no intellectual levels), the field is null and the gap is noted, not filled.
 *
 ...
 *   Quantitative (calculation-heavy) LOs: 29; discursive: 51 (see QUANTITATIVE_LOS).
 */
...
const SECTION_A1_LOS = {
  A1a: { section: 'A' as const, sub_area: 'A1', topic: 'The role and responsibility of senior financial executive/advisor', intellectual_level: 3 as const, quantitative: false,
    descriptor: 'Develop strategies for the achievement of the organisational goals in line with its agreed policy framework.' },
  A1b: { section: 'A' as const, sub_area: 'A1', topic: 'The role and responsibility of senior financial executive/advisor', intellectual_level: 3 as const, quantitative: false,
  ...
  A1c: { section: 'A' as const, sub_area: 'A1', topic: 'The role and responsibility of senior financial executive/advisor', intellectual_level: 3 as const, quantitative: false,
...
const SECTION_A2_LOS = {
  A2a: { section: 'A' as const, sub_area: 'A2', topic: 'Financial strategy formulation', intellectual_level: 3 as const, quantitative: true,
    descriptor: 'Assess organisational performance using methods such as ratios and trends.' },
  A2b: { section: 'A' as const, sub_area: 'A2', topic: 'Financial strategy formulation', intellectual_level: 3 as const, quantitative: false,
  ...
  A2c: { section: 'A' as const, sub_area: 'A2', topic: 'Financial strategy formulation', intellectual_level: 3 as const, quantitative: false,
    descriptor: 'Recommend appropriate distribution and retention policy.' },
  A2d: { section: 'A' as const, sub_area: 'A2', topic: 'Financial strategy formulation', intellectual_level: 3 as const, quantitative: false,
    descriptor: 'Explain the theoretical and practical rationale for the management of risk.' },
  A2e: { section: 'A' as const, sub_area: 'A2', topic: 'Financial strategy formulation', intellectual_level: 3 as const, quantitative: false,
  ...
  A2f: { section: 'A' as const, sub_area: 'A2', topic: 'Financial strategy formulation', intellectual_level: 3 as const, quantitative: false,
  ...
  A2g: { section: 'A' as const, sub_area: 'A2', topic: 'Financial strategy formulation', intellectual_level: 3 as const, quantitative: false,
    descriptor: 'Establish capital investment monitoring and risk management systems.' },
  A2h: { section: 'A' as const, sub_area: 'A2', topic: 'Financial strategy formulation', intellectual_level: 3 as const, quantitative: false,
...
const SECTION_A3_LOS = {
  A3a: { section: 'A' as const, sub_area: 'A3', topic: 'Corporate environmental, social, governance (ESG) and ethical issues', intellectual_level: 3 as const, quantitative: false,
  ...
  A3b: { section: 'A' as const, sub_area: 'A3', topic: 'Corporate environmental, social, governance (ESG) and ethical issues', intellectual_level: 3 as const, quantitative: false,
  ...
  A3c: { section: 'A' as const, sub_area: 'A3', topic: 'Corporate environmental, social, governance (ESG) and ethical issues', intellectual_level: 3 as const, quantitative: false,
    descriptor: 'Examine how the organisation manages its stakeholder groups as part of its social responsibilities.' },
  A3d: { section: 'A' as const, sub_area: 'A3', topic: 'Corporate environmental, social, governance (ESG) and ethical issues', intellectual_level: 3 as const, quantitative: false,
  ...
  A3e: { section: 'A' as const, sub_area: 'A3', topic: 'Corporate environmental, social, governance (ESG) and ethical issues', intellectual_level: 3 as const, quantitative: false,
  ...
  A3f: { section: 'A' as const, sub_area: 'A3', topic: 'Corporate environmental, social, governance (ESG) and ethical issues', intellectual_level: 3 as const, quantitative: false,
  ...
  A3g: { section: 'A' as const, sub_area: 'A3', topic: 'Corporate environmental, social, governance (ESG) and ethical issues', intellectual_level: 3 as const, quantitative: false,
    descriptor: 'Assess the impact of ethical and governance issues on the financial management of the organisation.' },
  A3h: { section: 'A' as const, sub_area: 'A3', topic: 'Corporate environmental, social, governance (ESG) and ethical issues', intellectual_level: 3 as const, quantitative: false,
...
const SECTION_A4_LOS = {
  A4a: { section: 'A' as const, sub_area: 'A4', topic: 'Management of international trade and finance', intellectual_level: 3 as const, quantitative: false,
    descriptor: 'Advise on the theory and practice of free trade and the management of barriers to trade.' },
  A4b: { section: 'A' as const, sub_area: 'A4', topic: 'Management of international trade and finance', intellectual_level: 3 as const, quantitative: false,
  ...
  A4c: { section: 'A' as const, sub_area: 'A4', topic: 'Management of international trade and finance', intellectual_level: 2 as const, quantitative: false,
  ...
  A4d: { section: 'A' as const, sub_area: 'A4', topic: 'Management of international trade and finance', intellectual_level: 2 as const, quantitative: false,
  ...
  A4e: { section: 'A' as const, sub_area: 'A4', topic: 'Management of international trade and finance', intellectual_level: 2 as const, quantitative: false,
  ...
  A4f: { section: 'A' as const, sub_area: 'A4', topic: 'Management of international trade and finance', intellectual_level: 2 as const, quantitative: false,
  ...
  A4g: { section: 'A' as const, sub_area: 'A4', topic: 'Management of international trade and finance', intellectual_level: 2 as const, quantitative: false,
...
const SECTION_A5_LOS = {
  A5a: { section: 'A' as const, sub_area: 'A5', topic: 'Strategic business and financial planning for multinationals', intellectual_level: 3 as const, quantitative: false,
...
const SECTION_A6_LOS = {
  A6a: { section: 'A' as const, sub_area: 'A6', topic: 'Dividend policy in multinationals and transfer pricing', intellectual_level: 3 as const, quantitative: true,
  ...
  A6b: { section: 'A' as const, sub_area: 'A6', topic: 'Dividend policy in multinationals and transfer pricing', intellectual_level: 3 as const, quantitative: true,
...
const SECTION_B1_LOS = {
  B1a: { section: 'B' as const, sub_area: 'B1', topic: 'Discounted cash flow techniques', intellectual_level: 3 as const, quantitative: true,
  ...
  B1b: { section: 'B' as const, sub_area: 'B1', topic: 'Discounted cash flow techniques', intellectual_level: 2 as const, quantitative: false,
  ...
  B1c: { section: 'B' as const, sub_area: 'B1', topic: 'Discounted cash flow techniques', intellectual_level: 3 as const, quantitative: true,
...
const SECTION_B2_LOS = {
  B2a: { section: 'B' as const, sub_area: 'B2', topic: 'Application of option pricing theory in investment decisions', intellectual_level: 3 as const, quantitative: true,
  ...
  B2b: { section: 'B' as const, sub_area: 'B2', topic: 'Application of option pricing theory in investment decisions', intellectual_level: 3 as const, quantitative: false,
    descriptor: 'Evaluate embedded real options within a project, classifying them into one of the real option archetypes.' },
  B2c: { section: 'B' as const, sub_area: 'B2', topic: 'Application of option pricing theory in investment decisions', intellectual_level: 3 as const, quantitative: true,
...
const SECTION_B3_LOS = {
  B3a: { section: 'B' as const, sub_area: 'B3', topic: 'Impact of financing on investment decisions and adjusted present values', intellectual_level: 3 as const, quantitative: false,
  ...
  B3b: { section: 'B' as const, sub_area: 'B3', topic: 'Impact of financing on investment decisions and adjusted present values', intellectual_level: 2 as const, quantitative: false,
  ...
  B3c: { section: 'B' as const, sub_area: 'B3', topic: 'Impact of financing on investment decisions and adjusted present values', intellectual_level: 2 as const, quantitative: false,
    descriptor: 'Discuss the role of green finance for organisations pursuing an environmental/sustainable agenda.' },
  B3d: { section: 'B' as const, sub_area: 'B3', topic: 'Impact of financing on investment decisions and adjusted present values', intellectual_level: 3 as const, quantitative: true,
  ...
  B3e: { section: 'B' as const, sub_area: 'B3', topic: 'Impact of financing on investment decisions and adjusted present values', intellectual_level: 3 as const, quantitative: true,
  ...
  B3f: { section: 'B' as const, sub_area: 'B3', topic: 'Impact of financing on investment decisions and adjusted present values', intellectual_level: 3 as const, quantitative: true,
  ...
  B3g: { section: 'B' as const, sub_area: 'B3', topic: 'Impact of financing on investment decisions and adjusted present values', intellectual_level: 3 as const, quantitative: false,
    descriptor: 'Discuss the benefits and limitations of duration including the impact of convexity.' },
  B3h: { section: 'B' as const, sub_area: 'B3', topic: 'Impact of financing on investment decisions and adjusted present values', intellectual_level: 3 as const, quantitative: true,
  ...
  B3i: { section: 'B' as const, sub_area: 'B3', topic: 'Impact of financing on investment decisions and adjusted present values', intellectual_level: 3 as const, quantitative: false,
  ...
  B3j: { section: 'B' as const, sub_area: 'B3', topic: 'Impact of financing on investment decisions and adjusted present values', intellectual_level: 3 as const, quantitative: true,
  ...
  B3k: { section: 'B' as const, sub_area: 'B3', topic: 'Impact of financing on investment decisions and adjusted present values', intellectual_level: 3 as const, quantitative: true,
...
const SECTION_B4_LOS = {
  B4a: { section: 'B' as const, sub_area: 'B4', topic: 'Valuation and the use of free cash flows', intellectual_level: 3 as const, quantitative: true,
  ...
  B4b: { section: 'B' as const, sub_area: 'B4', topic: 'Valuation and the use of free cash flows', intellectual_level: 3 as const, quantitative: true,
    descriptor: 'Forecast an organisation’s free cash flow and its free cash flow to equity (pre and post capital reinvestment).' },
  B4c: { section: 'B' as const, sub_area: 'B4', topic: 'Valuation and the use of free cash flows', intellectual_level: 3 as const, quantitative: true,
  ...
  B4d: { section: 'B' as const, sub_area: 'B4', topic: 'Valuation and the use of free cash flows', intellectual_level: 2 as const, quantitative: false,
...
const SECTION_B5_LOS = {
  B5a: { section: 'B' as const, sub_area: 'B5', topic: 'International investment and financing decisions', intellectual_level: 3 as const, quantitative: true,
    descriptor: 'Assess the impact upon the value of a project of alternative exchange rate assumptions.' },
  B5b: { section: 'B' as const, sub_area: 'B5', topic: 'International investment and financing decisions', intellectual_level: 2 as const, quantitative: true,
  ...
  B5c: { section: 'B' as const, sub_area: 'B5', topic: 'International investment and financing decisions', intellectual_level: 3 as const, quantitative: false,
  ...
  B5d: { section: 'B' as const, sub_area: 'B5', topic: 'International investment and financing decisions', intellectual_level: 3 as const, quantitative: false,
...
const SECTION_C1_LOS = {
  C1a: { section: 'C' as const, sub_area: 'C1', topic: 'Acquisitions and mergers versus other growth strategies', intellectual_level: 2 as const, quantitative: false,
    descriptor: 'Discuss the arguments for and against the use of acquisitions and mergers as a method of corporate expansion.' },
  C1b: { section: 'C' as const, sub_area: 'C1', topic: 'Acquisitions and mergers versus other growth strategies', intellectual_level: 3 as const, quantitative: false,
    descriptor: 'Evaluate the corporate and competitive nature of a given acquisition proposal.' },
  C1c: { section: 'C' as const, sub_area: 'C1', topic: 'Acquisitions and mergers versus other growth strategies', intellectual_level: 3 as const, quantitative: false,
    descriptor: 'Advise upon the criteria for choosing an appropriate target for acquisition.' },
  C1d: { section: 'C' as const, sub_area: 'C1', topic: 'Acquisitions and mergers versus other growth strategies', intellectual_level: 3 as const, quantitative: false,
  ...
  C1e: { section: 'C' as const, sub_area: 'C1', topic: 'Acquisitions and mergers versus other growth strategies', intellectual_level: 3 as const, quantitative: false,
  ...
  C1f: { section: 'C' as const, sub_area: 'C1', topic: 'Acquisitions and mergers versus other growth strategies', intellectual_level: 3 as const, quantitative: false,
...
const SECTION_C2_LOS = {
  C2a: { section: 'C' as const, sub_area: 'C2', topic: 'Valuation for acquisitions and mergers', intellectual_level: 3 as const, quantitative: true,
  ...
  C2b: { section: 'C' as const, sub_area: 'C2', topic: 'Valuation for acquisitions and mergers', intellectual_level: 3 as const, quantitative: true,
  ...
  C2c: { section: 'C' as const, sub_area: 'C2', topic: 'Valuation for acquisitions and mergers', intellectual_level: 3 as const, quantitative: true,
  ...
  C2d: { section: 'C' as const, sub_area: 'C2', topic: 'Valuation for acquisitions and mergers', intellectual_level: 2 as const, quantitative: false,
...
const SECTION_C3_LOS = {
  C3a: { section: 'C' as const, sub_area: 'C3', topic: 'Regulatory framework and processes', intellectual_level: 2 as const, quantitative: false,
  ...
  C3b: { section: 'C' as const, sub_area: 'C3', topic: 'Regulatory framework and processes', intellectual_level: 3 as const, quantitative: false,
...
const SECTION_C4_LOS = {
  C4a: { section: 'C' as const, sub_area: 'C4', topic: 'Financing acquisitions and mergers', intellectual_level: 3 as const, quantitative: false,
    descriptor: 'Compare the various sources of financing available for a proposed cash-based acquisition.' },
  C4b: { section: 'C' as const, sub_area: 'C4', topic: 'Financing acquisitions and mergers', intellectual_level: 3 as const, quantitative: true,
  ...
  C4c: { section: 'C' as const, sub_area: 'C4', topic: 'Financing acquisitions and mergers', intellectual_level: 3 as const, quantitative: true,
...
const SECTION_D1_LOS = {
  D1a: { section: 'D' as const, sub_area: 'D1', topic: 'Financial reconstruction', intellectual_level: 3 as const, quantitative: true,
  ...
  D1b: { section: 'D' as const, sub_area: 'D1', topic: 'Financial reconstruction', intellectual_level: 3 as const, quantitative: false,
...
const SECTION_D2_LOS = {
  D2a: { section: 'D' as const, sub_area: 'D2', topic: 'Business re-organisation', intellectual_level: 3 as const, quantitative: false,
    descriptor: 'Recommend, with reasons, strategies for unbundling parts of a quoted company.' },
  D2b: { section: 'D' as const, sub_area: 'D2', topic: 'Business re-organisation', intellectual_level: 3 as const, quantitative: true,
    descriptor: 'Evaluate the likely financial and other benefits of unbundling.' },
  D2c: { section: 'D' as const, sub_area: 'D2', topic: 'Business re-organisation', intellectual_level: 3 as const, quantitative: true,
...
const SECTION_E1_LOS = {
  E1a: { section: 'E' as const, sub_area: 'E1', topic: 'The role of the treasury function in multinationals', intellectual_level: 3 as const, quantitative: false,
  ...
  E1b: { section: 'E' as const, sub_area: 'E1', topic: 'The role of the treasury function in multinationals', intellectual_level: 3 as const, quantitative: false,
...
const SECTION_E2_LOS = {
  E2a: { section: 'E' as const, sub_area: 'E2', topic: 'The use of financial derivatives to hedge against forex risk', intellectual_level: 3 as const, quantitative: false,
  ...
  E2b: { section: 'E' as const, sub_area: 'E2', topic: 'The use of financial derivatives to hedge against forex risk', intellectual_level: 3 as const, quantitative: true,
  ...
  E2c: { section: 'E' as const, sub_area: 'E2', topic: 'The use of financial derivatives to hedge against forex risk', intellectual_level: 3 as const, quantitative: true,
...
const SECTION_E3_LOS = {
  E3a: { section: 'E' as const, sub_area: 'E3', topic: 'The use of financial derivatives to hedge against interest rate risk', intellectual_level: 3 as const, quantitative: true,
...
// ─────────────────────────────────────────────────────────────────────────────
// Section names (guide pp. 6–7). NOTE: the syllabus outline (p.6) omits "the"
// ("Role of senior financial adviser..."); the detailed guide header (p.7) reads
// "Role of the senior financial adviser...". The detailed-guide wording is used here.
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// Quantitative (calculation-heavy) learning outcomes — tagged for routing through
// the numeric-verification layer when drill generation starts. Derived from the
// per-LO `quantitative` field. 29 of the 80 technical LOs. See extraction report
// for the borderline judgement calls flagged for review.
// ─────────────────────────────────────────────────────────────────────────────

export const QUANTITATIVE_LOS: ReadonlySet<LoCode> = new Set(
  (Object.keys(SYLLABUS_MAP) as LoCode[]).filter((code) => SYLLABUS_MAP[code].quantitative),
);
...
// `quantitative` replaces APM's `calculation_required` flag semantics.
// ─────────────────────────────────────────────────────────────────────────────
...
export interface DrillSpec {
  ...
  quantitative:          boolean;   // true → routes through the numeric-verification layer
