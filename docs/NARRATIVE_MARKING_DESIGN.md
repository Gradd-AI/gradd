...
- **F9 anchor = J24 p.14.** The own-figure criterion, where present, cites the ACCA examiner statement verbatim (*"…using their own calculations… as long as their recommendation is consistent with their own workings"*, J24 p.14). F9 criteria appear **only** where the scenario supplies data the answer must use (D1 given MC figures; D2/D5 supplied cost/rate facts). Pure-conceptual criteria (much of D3/D4) carry no F9.
