...
BREADTH PASS COMPLETE: every examined-core LO (Tier 1 + Tier 2) now has at least one externally-checked drill. No voids remain in the examined syllabus. This is the launchable bank — a credible diagnostic surface across the whole examined APM syllabus, paired with Eli for teaching.
