...
**B-SECTION-LIVE TIER: CONTENT COMPLETE (46 published, 11 calculators + pipeline #2's 5 narrative drills) AND WALKED.** Tier claim + ads trigger: per Grant's pending ruling — both provenance-gate conditions (content shipped, pipeline walked) are now satisfied; the claim/ads decision itself is a business call, not a build gate.
